...
const BuiltIn = {
  ...
  defaultStartingBlock(text){
    ...
    component
    .addButtons(new UrlButton({title: 'View Website', url: faker.internet.url(),fallbackUrl: faker.internet.url()}))
    .addButtons(new PostbackButton({title: 'View Questionnaires'}))
    .addButtons(new UrlButton({
      title: 'View Privacy Policy',
      url: faker.internet.url(),
      fallbackUrl: faker.internet.url()
    }))
    .addButtons(new PostbackButton({
      title: 'Live Chat',
      payload:{}
    }))
