...
class GenericTemplate extends Component {
  ...
  get constraints () {
    return {
      component_type: {presence: true},
      payload: {presence: {message: 'Payload is required'}},
      'payload.template_type': {equality: ComponentTypes.TEMPLATE},
      elements: {length: {minimum: 0, maximum: 10, message: ' is limited to a maximum of %{count} allowed)'}}
    }
  }
